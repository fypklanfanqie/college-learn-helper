...
public class OpenCVLoader
{
    ...
    // initAsync()（OpenCV Engine 服务加载路径）已随 AsyncServiceHelper.java 一并移除：
    // 该路径依赖 AIDL 生成的 OpenCVEngineInterface，而 aidl.exe 无法处理含中文的工程路径。
    // 本项目使用 initDebug()/initLocal() 从应用包内加载本地库，不经过该服务。
}
